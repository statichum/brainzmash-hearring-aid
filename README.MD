...
The BrainzMash participant stack supports both Aurral/Lidarr metadata requests
and the read-only MusicBrainz requests used by Dropped Needle in the BrainzMash
