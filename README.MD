...
- Change image name to statichum/brainzmash-hearring-aid:latest


## 4. LMD stores image url’s for 30 days and wiki for 7, it may store invalid links from the old setup so we’ll clear all LMD caches:
